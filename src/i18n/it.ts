...
export const it: Translations = {
  ...
  hero: {
    ...
    description:
      "Il tracker di punteggio Bluetooth indossabile definitivo per ogni sport di racchetta. Tieni gli occhi sulla palla, segna i punti con un solo clic e lascia che l'app faccia il resto.",
  ...
  system: {
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Scegli lo sport, imposta le regole — e gioca.',
      },
    ],
  },
  ...
  appStory: {
    ...
    sections: {
      modes: {
        ...
        proof: [
          'Senza braccialetto: swipe',
          'Due braccialetti: ognuno per sé',
          'Da tre in su: torneo',
        ],
      ...
      summary: {
        ...
        proof: ['Nessun account', 'Funziona offline', 'Quattro lingue'],
        imageAlt: 'Il percorso di una partita nell’app Klikkr',
      },
    },
  },
  ...
  reviews: {
    ...
    form: {
      ...
      description: 'Giochi già con Klikkr? Raccontaci com’è andata.',
      namePlaceholder: 'Il tuo nome',
      ratingLabel: 'La tua valutazione',
      textPlaceholder: 'Raccontaci la tua esperienza con Klikkr …',
      submit: 'Invia recensione',
      ratingRequired: 'Seleziona una valutazione a stelle.',
      success: 'Il tuo client di posta sta per aprirsi — basta inviare!',
      mailSubject: 'Nuova recensione Klikkr',
    },
    items: [
      {
        name: 'Sandro L.',
        sport: 'Padel',
        rating: 5,
        text: 'Da quando uso Klikkr, posso concentrarmi completamente sul gioco. Niente più calcoli mentali, niente più discussioni – il carico cognitivo scompare del tutto. Fa davvero la differenza in partita.',
        date: '15 mar. 2026',
      },
      {
        name: 'Daniel K.',
        sport: 'Tennis',
        rating: 5,
        text: "La consegna è stata rapidissima e quando ho avuto una domanda, la risposta è arrivata nel giro di poche ore. Ecco com'è un buon servizio. Prodotto top, supporto top!",
        date: '22 mar. 2026',
      },
      {
        name: 'Markus B.',
        sport: 'Squash',
        rating: 5,
        text: 'Finalmente posso giocare a squash senza dover contare continuamente. Basta cliccare e continuare a giocare – così sì che ci si diverte!',
        date: '1 apr. 2026',
      },
    ],
  },
  ...
  cart: {
    ...
    newsletterOptIn: 'Sì, voglio ricevere la newsletter di Klikkr',
    remove: 'Rimuovi',
    total: 'Totale',
      ...
      swipe: {
        ...
        steps: [
          ...
          },
          {
            title: 'Swipe & Score',
            description:
              "Fai swipe verso l'alto sul tuo punteggio, così conti il punto. Per togliere un punto si passa dal menu.",
          },
        ],
        images: [
