  ...
  appFeatures: {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          'Suoni distintivi per ogni punto segnato e notifica unica di match point.',
      },
      {
  ...
  appWalkthrough: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          'Scansiona il codice QR sul braccialetto o seleziona il dispositivo dalla lista Bluetooth. Connesso in pochi secondi.',
      },
      {
