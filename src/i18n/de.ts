    ...
    items: [
      {
        ...
        sport: 'Padel',
        rating: 5,
        text: 'Seit ich Klikkr nutze, kann ich mich voll aufs Spiel konzentrieren. Kein Kopfrechnen mehr, keine Diskussionen – die kognitive Last fällt komplett weg. Das macht einen echten Unterschied im Match.',
        date: '15. März 2026',
      },
      {
        name: 'Daniel K.',
        sport: 'Tennis',
        rating: 5,
        text: 'Die Lieferung war blitzschnell und als ich eine Frage hatte, kam die Antwort innerhalb weniger Stunden. So stellt man sich guten Service vor. Produkt top, Support top!',
        date: '22. März 2026',
      },
      {
        name: 'Markus B.',
        sport: 'Squash',
        rating: 5,
        text: 'Endlich kann ich Squash spielen, ohne ständig mitzählen zu müssen. Einfach klicken und weiterspielen – so macht das richtig Spass!',
        date: '1. Apr 2026',
      },
    ],
  },
